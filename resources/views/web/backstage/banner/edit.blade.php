            ...
            <form role="form" action="{{route('backstage.banner.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="banner_name" class="form-control" id="inputEmail3" placeholder="请输入轮播图名称">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">排序值</label>
                        <div class="col-sm-10">
                            <input type="text" name="banner_sort" class="form-control" id="inputEmail3" placeholder="排序值越小在前">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label>
                            <input type="radio" name="status" id="optionsRadios1" value="1" checked="">是
                        </label>
                        <label>
                            <input type="radio" name="status" id="optionsRadios1" value="0" checked="">否
                        </label>
                    </div>
                    <div class="form-group">
